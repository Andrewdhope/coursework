...
The question in this analysis calls for a classification model. For this analysis I selected three common classification algorithms as candidtates for the final model. I ran the three models with default settings and observed if one would clearly outperform the others. I observed that a random forest did indeed outperform both gradient boosting and naive bayes.
